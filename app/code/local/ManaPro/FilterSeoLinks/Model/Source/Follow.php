 ...
 *
 */
class ManaPro_FilterSeoLinks_Model_Source_Follow extends Mana_Core_Model_Source_Abstract {
    protected function _getAllOptions() {
        /* @var $core Mana_Core_Helper_Data */ $core = Mage::helper(strtolower('Mana_Core'));
        $result = array();

        foreach ($core->getSortedXmlChildren(Mage::getConfig()->getNode('manapro_filterseolinks'), 'follow') as $key => $options) {
